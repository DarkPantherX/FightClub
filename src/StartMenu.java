...
public class StartMenu implements Menu{
	...
	public void render(Graphics2D g2) {
		...
		g2.drawString(msg,FightClub.WIDTH/2-130,(50*i+250+(FightClub.HEIGHT-500)));
		...
		if(introenemies.size()*30+25<FightClub.WIDTH&&((IntroEnemy)introenemies.get(introenemies.size()-1)).getX_Point()>50){
			...
			IntroEnemy enim = new IntroEnemy(-50, FightClub.HEIGHT-120, 30, 30, ou, 0);
		...
		if(introenemiess.size()*30+25<FightClub.WIDTH&&((IntroEnemy)introenemiess.get(introenemiess.size()-1)).getX_Point()<FightClub.WIDTH-50){
			
			IntroEnemy enim = new IntroEnemy(FightClub.WIDTH+50, 180+(FightClub.HEIGHT-500), 30, 30, ou, 1);
